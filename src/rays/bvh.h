...
const int B = 8; // Split spatial extent of primitives into B buckets (B is typically small: B < 32).
...
private:
    ...
    int compute_bucket(float val, float low, float high);
    void part(size_t node_idx, size_t max_leaf_size);
